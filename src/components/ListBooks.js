...
class ListBook extends Component {
  state = {
    BookList: [
      {
        "bookUserStatus": "currentlyReading",
  ...
  render() {
    const currentlyReadingList = this.state.BookList.filter(book => book.bookUserStatus === 'currentlyReading');
    const wantToReadList = this.state.BookList.filter(book => book.bookUserStatus === 'wantToRead');
    const readList = this.state.BookList.filter(book => book.bookUserStatus === 'read');
    const noneList = this.state.BookList.filter(book => book.bookUserStatus === 'none');
